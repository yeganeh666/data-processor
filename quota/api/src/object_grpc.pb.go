...
type ObjectServiceClient interface {
	PreUpload(ctx context.Context, in *PreUploadObjectReq, opts ...grpc.CallOption) (*PreUploadObjectRes, error)
}
...
func (c *objectServiceClient) PreUpload(ctx context.Context, in *PreUploadObjectReq, opts ...grpc.CallOption) (*PreUploadObjectRes, error) {
	out := new(PreUploadObjectRes)
	err := c.cc.Invoke(ctx, "/quota_api.ObjectService/PreUpload", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ObjectServiceServer interface {
	PreUpload(context.Context, *PreUploadObjectReq) (*PreUploadObjectRes, error)
}
...
func (UnimplementedObjectServiceServer) PreUpload(context.Context, *PreUploadObjectReq) (*PreUploadObjectRes, error) {
...
func _ObjectService_PreUpload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PreUploadObjectReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ObjectServiceServer).PreUpload(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/quota_api.ObjectService/PreUpload",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ObjectServiceServer).PreUpload(ctx, req.(*PreUploadObjectReq))
	}
...
var ObjectService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "quota_api.ObjectService",
	HandlerType: (*ObjectServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PreUpload",
			Handler:    _ObjectService_PreUpload_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "quota/api/object.proto",
}
